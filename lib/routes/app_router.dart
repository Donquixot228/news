...
import 'package:test1/pages/bookmark_page.dart';
...
class AppRouter {
  static Route onGenerateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case BookMark.routeName:
        return _FadeRoute(child:BookMark.create(), time: 0);
      case CategoriesPage.routeName:
        return _FadeRoute(child:CategoriesPage.create(), time: 0);
      default:
        return _errorRoute();
    }
  }
